...
<div class="container-fluid bg-secondary mb-5">
    <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
        <h1 class="font-weight-semi-bold text-uppercase mb-3">Quần áo trẻ em</h1>
        <div class="d-inline-flex">
            <p class="m-0"><a href="index.jsp">Trang chủ</a></p>
            <p class="m-0 px-2">-</p>
            <p class="m-0">Quần áo trẻ em</p>
        </div>
    </div>
</div>
<!-- Page Header End -->
...
<div class="container-fluid pt-5">
    <div class="row px-xl-5">
        ...
        <div class="col-lg-3 col-md-12">
            ...
            <div class="border-bottom mb-4 pb-4">
                ...
                <form>
                    ...
                    <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                        ...
                        <label class="custom-control-label" for="price-2">100.000đ - 300.000đ</label>
                        <span class="badge border font-weight-normal">295</span>
                    </div>
                    <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                        <input type="checkbox" class="custom-control-input" id="price-3">
                        <label class="custom-control-label" for="price-3">300.000đ - 500.000đ</label>
            ...
            <!-- Color Start -->
            <div class="border-bottom mb-4 pb-4">
                <h5 class="font-weight-semi-bold mb-4">Màu sác</h5>
                <form>
                    <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <div class="dropdown ml-4">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="triggerId">
                                ...
                                <a class="dropdown-item" href="#">Được mua nhiều</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <a href="detail?pid=${o.id}"><img class="img-fluid w-100" style="height: 350px" src="data:image/jpg;base64,${o.base64Image}" alt=""></a>                            </div>
                ...
                <div class="col-12 pb-1">
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-center mb-3">
                            <c:if test="${tag>1}">
                                <li class="page-item">
                                    <a class="page-link" href="children?index=${tag - 1}" aria-label="Previous">
                            ...
                            <c:forEach begin="1" end="${endP}" var="i">
                                <li class="${tag == i?"page-item active":"page-item"}"><a class="page-link"
                                                                                          href="children?index=${i}">${i}</a>
                                </li>
                            </c:forEach>
                            <c:if test="${tag<endP}">
                                <li class="page-item">
                                    <a class="page-link" href="children?index=${tag + 1}" aria-label="Next">
