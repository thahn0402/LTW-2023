...
<div class="container-fluid bg-secondary mb-5">
    <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
        <h1 class="font-weight-semi-bold text-uppercase mb-3">Túi</h1>
                        ...
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <a href="detail?pid=${o.id}"><img class="img-fluid w-100" style="height: 350px"
                                                                  src="data:image/jpg;base64,${o.base64Image}" alt=""></a></div>
                ...
                <div class="col-12 pb-1">
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-center mb-3">
                            <c:if test="${tag>1}">
                                <li class="page-item">
                                    <a class="page-link" href="handbag?index=${tag - 1}" aria-label="Previous">
                            ...
                            <c:forEach begin="1" end="${endP}" var="i">
                                <li class="${tag == i?"page-item active":"page-item"}"><a class="page-link"
                                                                                          href="handbag?index=${i}">${i}</a>
                                </li>
                            </c:forEach>
                            <c:if test="${tag<endP}">
                                <li class="page-item">
                                    <a class="page-link" href="handbag?index=${tag + 1}" aria-label="Next">
